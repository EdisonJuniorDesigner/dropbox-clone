class DropBoxController {
  ...
  connectFirebase() {
    ...
    var firebaseConfig = {
      apiKey: "AIzaSyC7pWCzoncx3Tkdfz_HyeEp-6ycagTb6M8",
      authDomain: "dropbox-clone-abaaa.firebaseapp.com",
      databaseURL: "https://dropbox-clone-abaaa.firebaseio.com",
      projectId: "dropbox-clone-abaaa",
      storageBucket: "dropbox-clone-abaaa.appspot.com",
      messagingSenderId: "1013862022331",
      appId: "1:1013862022331:web:a483f6115557c92f5f3d9e"
    };
  ...
  initEvents(){
    ...
    this.inputFilesEl.addEventListener('change', event => {
      ...
      //Leitura dos arquivos de upload e após (then) enviar os dados ao firebase
      this.uploadTask(event.target.files).then(responses => {

        /* 
        //Esse caminho vai para o Ajax
        ...
        */
        ...
        // Esse caminho vai para o Firebase
        responses.forEach(resp => {
  ...
  linkFiles(folder, name){

    // Nome do seu projeto no Firebase
    let projectId = 'dropbox-clone-abaaa';

    // Token de media do Firebase
    let token = '08159fcf-d7c0-44d8-947a-910bdac56ee6';

    let link = `https://firebasestorage.googleapis.com/v0/b/${projectId}.appspot.com/o/${folder}%2F${name}?alt=media&token=${token}`;
    ...
    li.addEventListener('dblclick', e => {
      ...
      switch (file.type){
        ...
        default:
          ...
          //Firebase
          window.open(this.linkFiles(this.currentFolder, file.name));
